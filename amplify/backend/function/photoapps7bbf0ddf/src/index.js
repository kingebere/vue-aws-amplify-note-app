/* Amplify Params - DO NOT EDIT
	API_PHOTOAPPS_GRAPHQLAPIENDPOINTOUTPUT
	API_PHOTOAPPS_GRAPHQLAPIIDOUTPUT
	ENV
	REGION
Amplify Params - DO NOT EDIT */
...
const appSyncUrl = process.env.API_PHOTOAPPS_GRAPHQLAPIENDPOINTOUTPUT;
const appSyncHost = new urlParse(appSyncUrl).hostname.toString();
console.log(appSyncUrl);
console.log(appSyncHost);
